...
import static com.rutaaprendizajewebflux.capability.domain.util.ExceptionConstants.MAXIMUM_AMOUNT_TECHNOLOGIES_EXCEPTION_MESSAGE;
import static com.rutaaprendizajewebflux.capability.domain.util.ExceptionConstants.MINIMUM_AMOUNT_TECHNOLOGIES_EXCEPTION_MESSAGE;
...
public final class Validator {
    ...
    private static void validateMaximumAmountOfTechnologies(CapabilityPlusTechnologiesModel capabilityPlusTechnologiesModel) {
        if (capabilityPlusTechnologiesModel.getTechnologies().size() > DomainConstants.MAX_TECHNOLOGIES) {
            throw new ValueNotValidException(MAXIMUM_AMOUNT_TECHNOLOGIES_EXCEPTION_MESSAGE.formatted(DomainConstants.MAX_TECHNOLOGIES));
        }
    }
    ...
    private static void validateMinimumAmountOfTechnologies(CapabilityPlusTechnologiesModel capabilityPlusTechnologiesModel) {
        if (capabilityPlusTechnologiesModel.getTechnologies().size() < DomainConstants.MIN_TECHNOLOGIES) {
            throw new ValueNotValidException(MINIMUM_AMOUNT_TECHNOLOGIES_EXCEPTION_MESSAGE.formatted(DomainConstants.MIN_TECHNOLOGIES));
        }
    }
}
